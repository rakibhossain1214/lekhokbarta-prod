...
function ProfileDetails({ userInfo, handleChange, userId, user }) {
    ...
    return (
        <Formik
            initialValues={{
                displayName: userInfo.displayName, email: userInfo.email, phoneNumber: userInfo.phoneNumber,
                occupation: userInfo.occupation, company: userInfo.company, address: userInfo.address,
                        ...
                        <div className='flex justify-between'>
                            <div className='order-last'>
                                {user !== null ?
                                    ...
                                    <button className='mt-3 mr-3 p-1' onClick={(e) => {
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 rounded-full text-teal-500 bg-gray-300" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div className="flex flex-col mt-4 ml-2">
                                ...
                                <div className="flex items-center">
                                    ...
                                    {!editable ?
                                        <p className='pl-1'>{userInfo.occupation !== '' ? userInfo.occupation : 'no occupation added'}</p>
                                        :
                                        <div className="form-group">
                                            <div className="border-b border-teal-500">
                                                <Field
                                ...
                                <div className="flex items-center">
                                    ...
                                    {!editable ?
                                        <p className='pl-1'>{userInfo.company !== '' ? userInfo.company : 'no company/instituition added'}</p>
                                        :
                                        <div className="form-group">
                                            <div className="border-b border-teal-500">
                                                <Field
                                ...
                                <div className="flex items-center">
                                    ...
                                    {!editable ?
                                        <p className='pl-1'>{userInfo.country !== '' ? userInfo.country : 'no country added'}</p>
                                        :
                                        <div className="form-group">
                                            <div className="border-b border-teal-500">
                                                <Field
