...
export async function addPostId(postId) {
...
export async function updatePost({ postData, values, selectedTags, selectedCategory }) {
...
export async function AddToFavoriteBlogs({
  ...
  await updateDoc(userRef, {
    favoriteBlogs: arrayUnion({ postId }),
  })
...
export async function RemoveFavoriteBlogs({
  ...
  const userRef = doc(db, 'users', user.uid)
  await updateDoc(userRef, {
    favoriteBlogs: arrayRemove({ postId })
  })
