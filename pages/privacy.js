...
function Privacy() {
  return (
    <div>
      ...
      <p className="mb-2">
        Your privacy is important to us. It is Roarspot's policy to respect your privacy regarding
        any information we may collect from you across our website, http://roarspot.com, and other
        sites we own and operate.
      </p>

      <h2 className="mb-2">1. Information we collect</h2>
      <h3 className="mb-2">Log data</h3>
      <p className="mb-2">
      ...
      <h3 className="mb-2">Device data</h3>
      <p className="mb-2">
      ...
      <p className="mb-2">We may ask for personal information, such as your:</p>
      <ul className="mb-2">
        <li>- Name</li>
        <li>- Email</li>
      ...
      <h2 className="mb-2">2. Legal bases for processing</h2>
      <p className="mb-2">
      ...
      <ul className="mb-2">
        <li>
          ...
          steps at your request before entering into such a contract (for example, when we provide a
          service you request from us);
        </li>
        <li>
          - it satisfies a legitimate interest (which is not overridden by your data protection
          interests), such as for research and development, to market and promote our services, and
      ...
      <h2 className="mb-2">3. Collection and use of information</h2>
      <p className="mb-2">
      ...
      <h2 className="mb-2">4. Disclosure of personal information to third parties</h2>
      ...
      <h2 className="mb-2">5. International transfers of personal information</h2>
      <p className="mb-2">
        The personal information we collect is stored and processed in India, Singapore, United
        States, Sri Lanka, Bangladesh and United Kingdom, or where we or our partners, affiliates
        and third-party providers maintain facilities. By providing us with your personal
      ...
      <h2 className="mb-2">6. Your rights and controlling your personal information</h2>
      <p className="mb-2">
        Choice and consent: By providing personal information to us, you consent to us collecting,
        holding, using and disclosing your personal information in accordance with this privacy
        policy. If you are under 16 years of age, you must have, and warrant to the extent permitted
        by law to us, that you have your parent or legal guardian’s permission to access and use the
        website and they (your parents or guardian) have consented to you providing us with your
        personal information. You do not have to provide personal information to us, however, if you
        do not, it may affect your use of this website or the products and/or services offered on or
        through it.
      </p>
      <p className="mb-2">
      ...
      <p className="mb-2">
        Restrict: You may choose to restrict the collection or use of your personal information. If
        you have previously agreed to us using your personal information for direct marketing
        purposes, you may change your mind at any time by contacting us using the details below. If
        you ask us to restrict or limit how we process your personal information, we will let you
        know how the restriction affects your use of our website or products and services.
      </p>
      <p className="mb-2">
        Access and data portability: You may request details of the personal information that we
        hold about you. You may request a copy of the personal information we hold about you. Where
        possible, we will provide this information in CSV format or other easily readable machine
        format. You may request that we erase the personal information we hold about you at any
        time. You may also request that we transfer this personal information to another third
        party.
      </p>
      <p className="mb-2">
      ...
      <p className="mb-2">
        Notification of data breaches: We will comply laws applicable to us in respect of any data
        breach.
      </p>
      <p className="mb-2">
        ...
        with your complaint. You also have the right to contact a regulatory body or data protection
        authority in relation to your complaint.
      </p>
      <p className="mb-2">
        Unsubscribe: To unsubscribe from our e-mail database or opt-out of communications (including
        marketing communications), please contact us using the details below or opt-out using the
        opt-out facilities provided in the communication.
      </p>

      <h2 className="mb-2">7. Cookies</h2>
      <p className="mb-2">
      ...
      <h2 className="mb-2">8. Business transfers</h2>
      <p className="mb-2">
      ...
      <h2 className="mb-2">9. Limits of our policy</h2>
      <p className="mb-2">
      ...
      <h2 className="mb-2">10. Changes to this policy</h2>
      <p className="mb-2">
      ...
      <h4 className="mt-4">Roarspot</h4>
      <p className="mb-2">roarspotmail@gmail.com</p>

      <p className="mb-2 mt-2">This policy is effective as of 1 November 2022.</p>
    </div>
  )
}
