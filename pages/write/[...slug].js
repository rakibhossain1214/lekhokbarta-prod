...
import {
  getPostFrontMatterByUserIdAndPostId,
  getAllTagsArray,
  updatePost,
  updatePostDraft,
  updatePostPublish,
...
import { updatePostSource } from '../../lib/firestoreConnection'
...
function CreateContent({ postData, auth, tagsOptions, defaultTags }) {
          ...
          () => {
            ...
            getDownloadURL(uploadTask.snapshot.ref).then((downloadURL) => {
              ...
              updateDoc(postRef, {
                ...
                'frontMatter.postThumbnail': downloadURL,
  ...
  const handlePostDraft = async () => {
    await updatePostDraft({ postData })
    setDraftToast(true)
    setTimeout(() => {
      setDraftToast(false)
    }, 3000)
  ...
  const handlePostPublish = async () => {
    await updatePostPublish({ postData })
  ...
  const handleSourceSave = async (e) => {
    e.preventDefault()
    updatePostSource({ postData, postSource })
    setSourceToast(true)
    setTimeout(() => {
  ...
  return (
    <div className="divide-y divide-gray-200 dark:divide-gray-700">
      <h5>
        Notes: Updating any field of your blog after publishing will lead to another review process.
      </h5>
      ...
      <div className="my-2 flex justify-end pt-2">
        <div className="text-base font-medium leading-6">
          <button
            ...
            className="focus:shadow-outline-blue mx-1 inline rounded-lg border border-transparent bg-red-500 px-4 py-1 text-sm font-medium leading-5 text-white shadow transition-colors duration-150 hover:bg-blue-700 focus:outline-none dark:hover:bg-blue-500"
          >
            Draft
          </button>
        </div>
      ...
      <div className="my-2 flex justify-start pt-6">
        <div className="text-base font-medium leading-6">
          {!imageLoad ? (
            postThumbnail !== undefined && postThumbnail !== '' ? (
              <div className="flex">
                <>
                  ...
                  />
                  <button
                    className="-ml-1 flex h-6 w-6 items-start"
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      strokeWidth="1.5"
                      className="z-10 -ml-1 h-5 w-5 rounded-full bg-red-500 text-gray-100 shadow-lg"
                      stroke="currentColor"
                    >
                      <path
                        strokeLinecap="round"
              ...
              <button className="mt-2 flex items-start rounded bg-teal-500 p-1 text-gray-100">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <div
              ...
              className="align-items-center flex justify-items-center"
            >
              <svg
                aria-hidden="true"
      ...
      <div className="flex justify-center">
        <div className="mb-3 mt-3 w-full">
          <label
            ...
            className="form-label mb-2 mr-2 inline-block pt-2 text-gray-700 dark:text-gray-300"
          >
            Sources
          </label>
          <textarea
          ...
          <div className="grid justify-items-end p-2">
            <button
              className="mr-2 flex rounded bg-teal-500 p-1 text-gray-100"
            ...
            >
              ...
              <span className="mr-2">Save sources</span>
            </button>
          </div>
        </div>
      </div>
        ...
        <AccordionDetails>
          <Formik
            initialValues={{
              ...
              category: postData.frontMatter.category.value,
